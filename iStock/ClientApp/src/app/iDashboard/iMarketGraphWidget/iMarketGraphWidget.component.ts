...
@Component({
  selector: 'iMarketGraphWidget',
  templateUrl: './iMarketGraphWidget.component.html',
  styleUrls: ['./iMarketGraphWidget.component.scss']

})
export class iMarketGraphWidgetComponent {
  public orderDetail:{}={
    OrderNumber:'',
    Name:'',
    Currency:'',
